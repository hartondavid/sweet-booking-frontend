...
const EditIngredient = ({ userRights }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        apiUpdateCakeIngredient((response) => { showSuccessToast(response.message) },
        ...
        <>
            <Box sx={{ m: 2 }}  >
                <Typography variant="h4" sx={{ mb: 2 }}>
                    <span className="font-bold text-black">{"Editeaza ingredient"}</span>
                </Typography>
